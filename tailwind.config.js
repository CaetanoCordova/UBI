...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        green: {
          DEFAULT: '#a0e8ac', // blush — botões, tabs ativas
          light: '#c5f7c8', // baby — badges, bordas
          subtle: '#f0fdf1', // visível — backgrounds de tela
          dark: '#7ac480', // mauve — textos em destaque
        },
        sage: {
        ...
        ink: {
          ...
          muted: '#90a89a', // cinza rosado — placeholder
